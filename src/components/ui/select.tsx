...
const selectTriggerVariants = cva(
    ...
    /* PostVIA compat: previous Trigger was w-fit pill. w-fit stays the
     ...
     flex bg-background w-fit items-center outline-none border border-input shadow-xs shadow-foreground/5 transition-shadow 
